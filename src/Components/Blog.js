				...
				<div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
					...
					<div className="space-y-4">
						<details className="w-full border rounded-lg">
							<summary className="px-4 py-6 focus:outline-none focus-visible:ring-emerald-800">What is the purpose of React Router?</summary>
						...
						<details className="w-full border rounded-lg">
							<summary className="px-4 py-6 focus:outline-none focus-visible:ring-emerald-800">How Context API works ?</summary>
						...
						<details className="w-full border rounded-lg">
							<summary className="px-4 py-6 focus:outline-none focus-visible:ring-emerald-800">What is useRef hook in react.js and what is it's purpose?</summary>
